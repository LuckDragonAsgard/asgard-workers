...
<title>Monica — 308/90 Buckley St</title>
<style>
...
.hero{background:linear-gradient(135deg,#44337a 0%,#6b46c1 100%);padding:40px 24px 32px;color:#fff;text-align:center}
...
.hero p{color:#d6bcfa;font-size:15px;max-width:520px;margin:0 auto;line-height:1.6}
...
.hs-item.green .num{color:#9ae6b4}.hs-item.green .desc{color:#b794f4}
.hs-item.blue .num{color:#d6bcfa}.hs-item.blue .desc{color:#b794f4}
.page{max-width:960px;margin:0 auto;padding:28px 16px}
.info-box{background:#fff;border-left:5px solid #6b46c1;border-radius:12px;padding:20px 24px;margin-bottom:24px;box-shadow:0 2px 8px rgba(0,0,0,.06)}
.info-box .ititle{font-size:16px;font-weight:800;color:#44337a;margin-bottom:8px}
.info-box p{font-size:14px;color:#4a5568;line-height:1.7}
.info-box strong{color:#6b46c1}
...
.why-section{background:#fff;border-radius:16px;padding:28px;margin-bottom:24px;border-left:5px solid #6b46c1;box-shadow:0 2px 8px rgba(0,0,0,.06)}
.why-section h2{font-size:20px;font-weight:800;color:#44337a;margin-bottom:4px}
...
.why-item{background:#faf5ff;border-radius:10px;padding:16px}
.why-item .icon{font-size:22px;margin-bottom:8px}
.why-item .title{font-size:14px;font-weight:700;color:#44337a;margin-bottom:4px}
.why-item .desc{font-size:13px;color:#553c9a;line-height:1.55}
...
.pos{color:#276749}.neg{color:#c53030}.muted{color:#a0aec0}.blue{color:#2b6cb0}.purple{color:#6b46c1}
...
.inp input:focus{outline:none;border-color:#6b46c1;background:#fff}
...
.rcard.green .rv{color:#276749}.rcard.purple .rv{color:#6b46c1}.rcard.yellow .rv{color:#744210}.rcard.blue .rv{color:#2b6cb0}
...
.summary-box{background:linear-gradient(135deg,#44337a 0%,#6b46c1 100%);color:#fff;border-radius:14px;padding:28px;text-align:center;margin-top:0}
.summary-box .big{font-size:52px;font-weight:900;line-height:1;color:#b794f4}
.summary-box .label{font-size:15px;color:#d6bcfa;margin-top:8px;font-weight:600}
.summary-box .ssub{font-size:13px;color:#b794f4;margin-top:6px;line-height:1.6}
...
.accel-box{background:linear-gradient(135deg,#44337a,#6b46c1);color:#fff;border-radius:14px;padding:24px;text-align:center}
.accel-big{font-size:56px;font-weight:900;line-height:1;color:#68d391}
.accel-label{font-size:14px;color:#d6bcfa;margin-top:8px;font-weight:600}
.accel-sub{font-size:13px;color:#b794f4;margin-top:6px;line-height:1.7}
...
<body>
<div class="hero">
  <div class="tag">MONICA — 308/90 BUCKLEY ST, FOOTSCRAY</div>
  <h1>Your 308 becomes an investment property</h1>
  <p>Move into 713 next door. A tenant covers most of your mortgage. ATO deductions go to your wallet each fortnight. Your Footscray equity keeps building.</p>
...
<div class="page">
  ...
  <div class="info-box">
    ...
    <p>You move into 713 Buckley and pay <strong>$570/wk</strong> rent. Your 308 goes on the open rental market — a tenant pays you ~<strong>$440/wk</strong>. Your mortgage interest, body corp, council rates, insurance and depreciation all become tax-deductible now that 308 is an investment property. The ATO refunds that tax either fortnightly via your pay (PAYG variation) or at tax time. The <strong>6-year CGT absence rule</strong> means 308 stays as your principal residence for tax purposes — sell within 6 years and all capital gains are completely tax-free.</p>
  </div>

  <div class="tax-how">
    <div class="ititle">How the tax mechanism works</div>
    <p>Every expense on your IP — interest, body corp, rates, insurance — becomes a tax deduction. On top of that, <strong>depreciation</strong> is a paper deduction the ATO gives you for the wear and tear of fittings, carpets and the building structure. You spend no cash to claim it — a quantity surveyor visits once (~$500, tax-deductible) and produces a yearly schedule. At your tax bracket, roughly <strong>32.5 cents per dollar of deductions</strong> comes back as a tax refund. Lodge a PAYG variation and that refund hits your pay fortnightly, not just at tax time.</p>
  </div>

  <div class="why-section">
    <h2>Why the cashflow works in your favour</h2>
    <p class="sub">Five financial mechanisms that change once 308 is an IP</p>
    <div class="why-grid">
      <div class="why-item"><div class="icon">🏢</div><div class="title">Bigger apartment, same building</div><div class="desc">713 is bigger than 308 — same complex, same suburb, no commute change.</div></div>
      <div class="why-item"><div class="icon">💰</div><div class="title">A tenant covers most of your mortgage</div><div class="desc">Tenant pays ~$440/wk. Your mortgage repayment is ~$492/wk. The gap is small, and ATO deductions close it — money you were never getting as an owner-occupier.</div></div>
      <div class="why-item"><div class="icon">🏛️</div><div class="title">The ATO subsidises you</div><div class="desc">Interest, body corp, rates, insurance and depreciation are all deductible. At your tax bracket, roughly 32.5c per dollar of deductions comes back via your fortnightly pay.</div></div>
      <div class="why-item"><div class="icon">🛡️</div><div class="title">Zero CGT for 6 years</div><div class="desc">308 stays your PPOR for tax purposes for up to 6 years. Sell within that window and every dollar of Footscray growth is tax-free. Just do not nominate another property as PPOR.</div></div>
      <div class="why-item"><div class="icon">📈</div><div class="title">Equity builds two ways</div><div class="desc">Tenant rent pays down your loan. Footscray appreciates. You build wealth without spending more than you do now.</div></div>
    </div>
  </div>

  
  <div style="background:linear-gradient(135deg,#44337a 0%,#6b46c1 100%);border-radius:16px;padding:28px;margin-bottom:24px;color:#fff;text-align:center">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:14px;max-width:880px;margin:0 auto">
      ...
      <div style="background:rgba(255,255,255,.12);border-radius:12px;padding:16px"><div style="font-size:32px;font-weight:900;line-height:1" id="banner-equity">$0</div><div style="font-size:12px;opacity:.85;margin-top:4px">Equity in 308 at year 10</div></div>
  ...
  <div class="vs-section">
    ...
    <p class="sub">What changes financially each week once 308 is an IP. Edit any number in the calculator below.</p>
    <div class="vs-grid">
      <div class="vs-col before">
        ...
        <div class="vline"><span class="vl">Body corp + rates</span><span class="vv neg" id="b-bcr"></span></div>
        <div class="vline"><span class="vl">Rental income</span><span class="vv muted">$0</span></div>
        <div class="vline"><span class="vl">Tax deductions</span><span class="vv muted">None</span></div>
        <div class="vtotal"><span>Weekly cost of 308</span><span class="neg" id="b-total"></span></div>
      </div>
      <div class="vs-col after">
        <h3>As an investment property</h3>
        <div class="vline"><span class="vl">Tenant rent (308)</span><span class="vv pos" id="a-rin"></span></div>
        ...
        <div class="vline"><span class="vl">Insurance</span><span class="vv neg" id="a-ins"></span></div>
        <div class="vline"><span class="vl">ATO tax refund (in your pay)</span><span class="vv pos" id="a-tax"></span></div>
        <div class="vline"><span class="vl">Rent you pay (713)</span><span class="vv neg" id="a-rout"></span></div>
    ...
    <div class="diff-bar pos" id="diff-bar">
      <span class="dlabel" id="diff-label">Weekly diff vs staying as your home (includes rent you pay elsewhere)</span>
      <span class="dval" id="diff-val">-</span>
    </div>
  </div>
<div class="calc-section">
    <h2>Your figures — edit anything</h2>
    <p class="sub">All numbers update live. Estimates pre-filled — update with your actuals.</p>
    ...
    <div class="inputs-grid">
      <div class="inp"><label>Your Annual Salary ($)</label><input id="salary" type="number" value="85000"></div>
      <div class="inp"><label>Mortgage Balance ($)</label><input id="loan" type="number" value="320000"><span class="hint">Update with your actual balance</span></div>
      <div class="inp"><label>Interest Rate (%)</label><input id="rate" type="number" value="5.5" step="0.01"></div>
      <div class="inp"><label>Monthly Repayment ($)</label><input id="repayment" type="number" value="1965"></div>
      <div class="inp"><label>Tenant Rent — 308 ($/wk)</label><input id="rent_in" type="number" value="460"><span class="hint">Market rate 1-bed Footscray</span></div>
      <div class="inp"><label>Rent You Pay — 713 ($/wk)</label><input id="rent_out" type="number" value="540"></div>
      <div class="inp"><label>Body Corporate ($/wk)</label><input id="bc" type="number" value="30"></div>
      <div class="inp"><label>Council Rates ($/wk)</label><input id="rates" type="number" value="25"></div>
      <div class="inp"><label>Landlord Insurance ($/wk)</label><input id="ins" type="number" value="12"></div>
      <div class="inp"><label>Maintenance avg ($/wk)</label><input id="maint" type="number" value="10"><span class="hint">Apartments low maintenance — ~$10/wk reserve</span></div>
      ...
      <div class="inp"><label>Depreciation ($/yr)</label><input id="dep" type="number" value="11000"><span class="hint">From QS report — paper claim only</span></div>
      <div class="inp"><label>Current Property Value ($)</label><input id="propval" type="number" value="450000"></div>
      <div class="inp"><label>Vacancy allowance (%)</label><input id="vacancy" type="number" value="3" step="1"><span class="hint">Industry standard 4%: ~2 weeks/yr empty between tenants</span></div>
...
<div class="results-grid">
      ...
      <div class="rcard purple"><div class="rv" id="r-coverage">-</div><div class="rl">Tenant covers X% of mortgage</div></div>
    </div>
    <div class="tax-box">
  ...
  <div class="lt-section">
    ...
    <p class="sub">What 308 Buckley builds for you over time</p>
    <table class="lt-table">
      <thead><tr><th></th><th>Today</th><th>Year 3</th><th>Year 5</th><th>Year 10</th></tr></thead>
      <tbody>
        <tr><td>308 Buckley value</td><td id="lt-v0"></td><td id="lt-v3"></td><td id="lt-v5"></td><td id="lt-v10"></td></tr>
    ...
    <div class="cgt-box">
      ...
      <div class="csub">ATO 6-year absence rule. 308 Buckley stays your PPOR. Every dollar of Footscray growth is tax-free. Do not nominate another property as PPOR.</div>
    </div>
    <div class="summary-box">
      <div class="big" id="lt-total10">$0</div>
      <div class="label">Estimated total wealth built over 10 years</div>
      <div class="ssub">Footscray growth + loan paid down by tenant rent + 10 years of ATO tax savings.</div>
    </div>
  </div>
  ...
  <div style="background:#fffff0;border:1.5px solid #faf089;border-radius:12px;padding:18px 22px;margin-bottom:24px;font-size:13px;color:#744210;line-height:1.65">
    ...
    Only ONE property at a time can be your "principal place of residence" for tax purposes. The 6-year CGT exemption above assumes you nominate 308 as your PPOR for tax (even though you live elsewhere). If you nominate a different property as PPOR, 308 will be subject to CGT pro-rata on any gain. You can change designation later, but only one property qualifies for the exemption at any given time.
  </div>

  <div class="payoff-section">
    <h2>How the cashflow pays off 308 faster</h2>
    <p class="sub">Without IP cashflow you pay the standard repayment alone. With it, tenant rent plus the ATO refund frees up extra cash every month that goes straight back into the 308 mortgage.</p>
    ...
    <div class="payoff-grid">
      <div class="payoff-col slow">
        ...
        <div class="payoff-label">years to pay off 308</div>
    ...
    <div class="accel-box">
      ...
      <div class="accel-label">years earlier you own 308 Buckley outright</div>
      <div class="accel-sub">Interest you never pay: <strong id="py-int-saved" style="color:#fff">-</strong><br>Tenant rent + ATO refund generates this — no extra cash from you required.</div>
    </div>
  </div>
  ...
  <div class="next-section">
    ...
    <div class="next-steps">
      <div class="next-step"><div class="ns-num">1</div><div class="ns-body"><div class="ns-title">Sign a written lease at $440/wk</div><div class="ns-desc">The ATO requires a written lease at market rent for deductions to hold. One page, signed. Without it, deductions can be reduced or disallowed. Whoever the tenant is — agent or private — get the lease in writing.</div></div></div>
      <div class="next-step"><div class="ns-num">2</div><div class="ns-body"><div class="ns-title">Lodge a PAYG withholding variation</div><div class="ns-desc">One-page ATO form telling your employer to withhold less tax from each pay. Free, takes about 10 minutes online. Gets the saving into your bank fortnightly rather than waiting for tax time.</div></div></div>
      <div class="next-step"><div class="ns-num">3</div><div class="ns-body"><div class="ns-title">Get a depreciation report for 308</div><div class="ns-desc">A quantity surveyor visits and calculates exactly what you can claim each year. Around $500 one-off, tax-deductible itself. The figure in this calculator is an estimate — the report gives you the accurate number.</div></div></div>
      <div class="next-step"><div class="ns-num">4</div><div class="ns-body"><div class="ns-title">Set up an offset account for the extra repayments</div><div class="ns-desc">The payoff acceleration only works if the freed-up cash actually hits the mortgage. Ask your bank to open an offset account on your 308 loan and redirect the monthly saving straight in.</div></div></div>
    </div>
  </div>
...
var fmt=function(n,p){return (n>=0&&p?"+":n<0?"-":"")+"$"+Math.abs(Math.round(n)).toLocaleString();};
var fwk=function(n){return fmt(n,n>0)+"/wk";};
var br=function(s){return s<=18200?0:s<=45000?19:s<=120000?32.5:s<=180000?37:45;};
var fv=function(v,r,y){return v*Math.pow(1+r/100,y);};
...
function calc(){
  ...
  var nowYear=2026;
  var f2=function(n){return "$"+Math.abs(Math.round(n)).toLocaleString();};
