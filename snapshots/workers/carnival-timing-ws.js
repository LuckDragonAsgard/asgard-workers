...
var CarnivalRoom = class {
  ...
  async pushToD1(stateData, resultKey, resultData) {
    ...
    const carnivalCode = (this.state.id && this.state.id.name ? this.state.id.name : "unknown").toUpperCase();
    try {
      await fetch(
